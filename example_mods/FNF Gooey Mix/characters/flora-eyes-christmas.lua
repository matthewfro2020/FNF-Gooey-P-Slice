...
function onCreatePost()
  ...
  if getProperty('dad.curCharacter') == CHAR then
    setProperty('dadCameraOffset', {0, 120})
  ...
  if getProperty('gf.curCharacter') == CHAR then
    setProperty('gfCameraOffset', {0, 120})
    setProperty('gf.flipX', true)
    setProperty('gf.scale.x', 1); setProperty('gf.scale.y', 1)
  end

-- Animation offsets map
  offsets["danceLeft"] = {-20, 210}
  offsets["danceRight"] = {-20, 210}
  offsets["combo50"] = {-20, 210}
  offsets["combo200"] = {-20, 210}
  offsets["drop70"] = {-20, 210}
