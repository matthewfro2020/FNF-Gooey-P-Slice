...
-- Character: gooey-drippy
-- Image: characters/extra/DrippyGooey
-- This script sets camera offsets, icon, flip, and exposes animation offsets for tuning.
-- Drop into mods/characters/gooey-drippy.lua

local CHAR = "gooey-drippy"
local offsets = {}
...
-- Animation offsets map
  offsets["idle"] = {15, -40}
  offsets["singLEFT"] = {15, -40}
  offsets["singDOWN"] = {15, -40}
  offsets["singUP"] = {15, -40}
  offsets["singRIGHT"] = {15, -40}
  offsets["singLEFTmiss"] = {15, -40}
  offsets["singDOWNmiss"] = {15, -40}
  offsets["singUPmiss"] = {15, -40}
  offsets["singRIGHTmiss"] = {15, -40}
  offsets["firstDeath"] = {15, -40}
  offsets["deathLoop"] = {15, -40}
  offsets["deathConfirm"] = {15, -40}
