...
-- Character: gooey-car
-- Image: characters/gooey/GooeyCar
-- This script sets camera offsets, icon, flip, and exposes animation offsets for tuning.
-- Drop into mods/characters/gooey-car.lua

local CHAR = "gooey-car"
local offsets = {}
...
-- Animation offsets map
  offsets["idle"] = {12, -110}
  offsets["idle-hold"] = {12, -110}
  offsets["singLEFT"] = {12, -110}
  offsets["singLEFT-hold"] = {12, -110}
  offsets["singDOWN"] = {12, -110}
  offsets["singDOWN-hold"] = {12, -110}
  offsets["singUP"] = {12, -110}
  offsets["singUP-hold"] = {12, -110}
  offsets["singRIGHT"] = {12, -110}
  offsets["singRIGHT-hold"] = {12, -110}
