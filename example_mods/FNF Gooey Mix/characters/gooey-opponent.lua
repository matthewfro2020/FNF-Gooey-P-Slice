...
-- Character: gooey-opponent
-- Image: characters/gooey/Gooey
-- This script sets camera offsets, icon, flip, and exposes animation offsets for tuning.
-- Drop into mods/characters/gooey-opponent.lua

local CHAR = "gooey-opponent"
local offsets = {}
...
-- Animation offsets map
  ...
  offsets["singLEFT-alt"] = {12, -110}
  offsets["singDOWN-alt"] = {12, -110}
  offsets["singUP-alt"] = {12, -110}
  offsets["singRIGHT-alt"] = {12, -110}
