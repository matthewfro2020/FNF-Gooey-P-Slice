...
function onCreatePost()
  ...
  if getProperty('dad.curCharacter') == CHAR then
    setProperty('dadCameraOffset', {-200, -230})
  ...
  if getProperty('gf.curCharacter') == CHAR then
    setProperty('gfCameraOffset', {-200, -230})
