...
-- Character: gooey-stress
-- Image: characters/gooey/GooeyStress
-- This script sets camera offsets, icon, flip, and exposes animation offsets for tuning.
-- Drop into mods/characters/gooey-stress.lua

local CHAR = "gooey-stress"
local offsets = {}
...
-- Animation offsets map
  ...
  offsets["cock"] = {12, -110}
  offsets["fakeIdle"] = {12, -110}
  offsets["2fakeIdle"] = {12, -110}
  offsets["shoot"] = {324, 37}
  offsets["ruhRohRaggy"] = {12, -110}
  offsets["omgFriend"] = {12, -110}
  offsets["crystalGlow"] = {12, -110}
  offsets["chickenJockey"] = {12, -110}
